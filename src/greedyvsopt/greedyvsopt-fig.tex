...
{[nodes={pink node, onslide=<8->{show}}] 9, 10},
...
{[nodes={pink node}] 9'/9, 10'/10[onslide=<4->{hide}]};
...
%% CALLOUTS
\onslide<11->{
\node[text width=2.2cm, callout={(1.north)}] at (-3, 0) 
{less conflicts than the size of the component};
}

\onslide<12->{
\node[text width=3.1cm, callout={(15'.south)}] at (4.4, -4.8) 
